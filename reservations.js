(()=>{
  ...
  async function cancelReservation(id){
    ...
    const {error}=await sb.rpc('staff_cancel_reservation_notification',{p_id:id,p_reason:reason.trim(),p_notify:notify});
    if(error)return toast(error.message);
