...
O script consulta a caixa de entrada e a fila do Supabase uma vez por hora.
...
Depois execute manualmente `configurarIntegracao` uma única vez e autorize Gmail, conexões externas e gatilhos. A função cria o marcador `LabInfo-Processado`, instala o gatilho de uma hora e faz a primeira execução.
